...
qcm_ds.calQCM_lagoon_WL.plot(color='r',ax=axes[0])
qcm_ds.obs_lagoon_WL.plot(color='b',ax=axes[0])
qcm_ds.z_thalweg.plot(color='gray',ax=axes[0])

qcm_ds.w_inlet.plot(color='g',ax=axes[1])
