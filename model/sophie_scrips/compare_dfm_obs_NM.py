...
run_name ="run_tide_test-v108"
fign = 7
run_desc = 'Grid v03-deep - as built bathy' 
...
# nmp (north pond middle), pch_up (up channel)

# fname = 'E:/proj/Pescadero/Model_Runs/Testing/run_tide_test_v16F-DS/Project16F.dsproj_data/flowfm/output/flowfm_his.nc'
...
bml_odir ='E:/proj/Pescadero/data/BML_data/2020_2021/waterlevel_processed/'

d = {'model_st_nb':[0,7,5,4,11],
      'BML_fname':['PCH_processed.csv','NCK_processed.csv','CH2_processed.csv','BC3_processed.csv','NMP_processed.csv'],
      'Title':['PCH','NCK','CH2','BC3','NMP']}
...
def formatBML(fname):
    ...
    df['time'] = pd.to_datetime(df.time)-dtime_off
    df['waterlevel'] = df['depth_m']+offset
...
fig, ax = plt.subplots(5, 1, sharex='col',figsize=(8,16),num=fign)
