# -*- coding: utf-8 -*-
"""
Created on Sun May 23 19:14:31 2021
...
file_nc_map = os.path.join(dir_testinput,'run_tide_test-v12A','DFM_OUTPUT_flowfm','flowfm_map.nc')
file_nc_his = os.path.join(dir_testinput,'run_tide_test-v12A','DFM_OUTPUT_flowfm','flowfm_his.nc')
