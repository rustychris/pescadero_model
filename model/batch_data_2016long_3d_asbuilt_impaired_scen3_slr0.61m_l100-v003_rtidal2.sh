...
python run_restart_highres.py --mdu data_2016long_3d_asbuilt_impaired_scen3_slr0.61m_l100-v003/flowfm.mdu --start=2016-07-31T00:00 --duration=72h --suffix=rtidal2
