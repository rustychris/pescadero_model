...
#SBATCH -n 32
#SBATCH -N 1
#SBATCH --time 16-20:00:00

# Testing reproducibility of Low vs Medium salt differences in early Sept.
# Of course, luck and all, Medium crashed with MPI error.
...
python run_production_bmi.py --resume --mdu data_2016long_3d_asbuilt_impaired_scen2_l100-v008/flowfm.mdu -n 16 --three-d --terrain asbuilt -l 100 -p 2016long -s scen2 -f impaired
