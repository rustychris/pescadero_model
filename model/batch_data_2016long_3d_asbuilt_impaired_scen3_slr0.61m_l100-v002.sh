...
python run_production_bmi.py --run-dir data_2016long_3d_asbuilt_impaired_scen3_slr0.61m_l100-v002 -s scen3 -n 16 --three-d --terrain asbuilt -l 100 -p 2016long -f impaired --slr 0.6096
