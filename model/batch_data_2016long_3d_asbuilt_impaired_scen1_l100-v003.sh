...
python run_production_bmi.py --run-dir data_2016long_3d_asbuilt_impaired_scen1_l100-v003 -n 16 -s scen1 --three-d --terrain asbuilt -l 100 -p 2016long -f impaired
