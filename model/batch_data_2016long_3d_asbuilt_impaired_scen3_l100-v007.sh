...
python run_production_bmi.py --run-dir data_2016long_3d_asbuilt_impaired_scen3_l100-v007 -n 16 --three-d --terrain asbuilt -l 100 -p 2016long -s scen3 -f impaired
