...
python run_production_bmi.py --run-dir data_2016long_3d_asbuilt_unimpaired_scen0_slr0.61m_l100-v001 -n 16 --three-d --terrain asbuilt -l 100 -p 2016long -f unimpaired --slr 0.6096
