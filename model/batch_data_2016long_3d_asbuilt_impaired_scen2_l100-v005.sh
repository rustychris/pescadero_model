...
python run_production_bmi.py --run-dir data_2016long_3d_asbuilt_impaired_scen2_l100-v005 -n 16 --three-d --terrain asbuilt -l 100 -p 2016long -s scen2 -f impaired
