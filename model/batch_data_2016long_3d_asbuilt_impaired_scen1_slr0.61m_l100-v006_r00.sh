...
python run_production_bmi.py --resume --mdu data_2016long_3d_asbuilt_impaired_scen1_slr0.61m_l100-v006/flowfm.mdu -n 16 --three-d --terrain asbuilt -l 100 -p 2016long -f impaired --slr 0.6096 -s scen1
