...
g_exist=unstructured_grid.UnstructuredGrid.read_ugrid('pesca_butano_v00_existing_bathy.nc')
g_built=unstructured_grid.UnstructuredGrid.read_ugrid('pesca_butano_v00_asbuilt_bathy.nc')
